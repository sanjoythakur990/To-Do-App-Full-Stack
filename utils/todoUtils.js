...
const sendVerificationMail= (email, token)=>{
    ...
    const transporter= nodemailer.createTransport({
        ...
        port: 465,
        secure: true,
        service: "gmail",    // service provider is gmail. The email which will be sending mails to users
        auth: {
            user: "techgeek608@gmail.com",
            pass: process.env.APP_PASSWORD
        }
    })
    // mail options
    const mailOptions={
        from: 'techgeek608@gmail.com',
        to: email,
        subject: "Email Verification for Your To-do app",
        // html: `<a href="http::localhost8000/verify/${token}">Click Here</a>`      => this one line can work also
        html: `<head>
